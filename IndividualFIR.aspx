<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndividualFIR.aspx.cs" Inherits="IndividualFIR" %>
...
<body style="background-color:white;">
    ...
    <td>   
       &nbsp;</td>  
        <td>  
        <asp:TextBox ID="textinput" runat="server" placeholder="Search here..." Width="238px" ForeColor="Black" ></asp:TextBox>  
        </td>  
        <td>   
        <asp:Button ID="Button1" runat="server" Text="Go" onclick="Button1_Click" BackColor="#0099FF" Width="84px" />  
        </td>  
...
<table><tr><td><p><asp:Label ID="Label2" runat="server"></asp:Label>  </p></td></tr>  
        ...
        <asp:DetailsView ID="GridView1" runat="server" BackColor="#CCCCCC" BorderColor="BlueViolet" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" EnableModelValidation="True" ForeColor="Black" Height="74px" Width="363px" Caption="FIR Details">
        ...
        <asp:Button ID="Button2" CssClass="button" runat="server" Text="Export to PDF" OnClick="Button2_Click" BackColor="#00CC00" Width="180px" />  
    </form>  
